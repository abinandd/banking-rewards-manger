...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-72 bg-slate-900 border-r border-slate-800 h-full overflow-y-auto flex flex-col justify-between p-4 flex-shrink-0 text-slate-300">
      <div>
        {/* Branding */}
        ...
        <div className="space-y-1">
          <div className="px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-slate-500 mb-1">
            ...
            return (
              <button
                ...
                className={`w-full flex items-center space-x-3 px-3 py-3 rounded-xl text-sm font-medium transition-all ${
                  isActive
                    ? 'bg-emerald-500/10 text-emerald-400 shadow-sm border border-emerald-500/20 font-semibold'
      ...
      <div className="mt-8 space-y-4">
        {/* User Switcher */}
        {!isAdmin && (
          <div className="flex flex-col space-y-2 bg-slate-800/50 p-3 rounded-xl border border-slate-800">
            <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500">Active Customer</span>
            <div className="flex items-center space-x-2">
              <UserIcon className="h-4 w-4 text-emerald-400" />
              <select
                className="bg-transparent text-sm font-medium text-slate-200 focus:outline-none cursor-pointer w-full"
        ...
        <button
          ...
          className={`w-full flex items-center justify-center space-x-2 px-3 py-3 rounded-xl text-xs font-bold transition-all border ${
            isAdmin
        ...
        <div className="flex items-center space-x-3 p-3 bg-slate-950/50 rounded-xl border border-slate-800/50">
          <div className="h-9 w-9 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center font-bold text-sm shadow-md text-white">
