...
export const Sidebar: React.FC<SidebarProps> = ({
 ...
 <div>
 <span className="text-xl font-semibold tracking-tight bg-gradient-to-r from-white via-slate-200 to-emerald-400 bg-clip-text text-transparent block">
 VaultRewards
 </span>
 ...
 <div className="px-3 py-2 text-[10px] font-semibold uppercase tracking-wider text-slate-500 mb-1">
 ...
 <span className="text-[10px] font-semibold uppercase tracking-wider text-slate-500">Active Customer</span>
 ...
 className={`w-full flex items-center justify-center space-x-2 px-3 py-3 rounded-xl text-xs font-semibold transition-all ${
 isAdmin
