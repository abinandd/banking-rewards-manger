...
export const ReferralPage: React.FC<ReferralPageProps> = ({
 ...
 <span className="text-xs font-medium uppercase tracking-wider">Your Referral Code</span>
 </div>
 <div className="text-3xl sm:text-4xl font-bold mt-2 tracking-widest bg-white/10 px-4 py-2 rounded-2xl -white/20 inline-block">
 ...
 <button
 onClick={handleCopy}
 className="flex items-center justify-center space-x-2 px-6 py-3 bg-white text-emerald-800 hover:bg-emerald-50 font-medium rounded-2xl transition active:scale-95"
 >
 ...
 type="submit"
 disabled={loading}
 className="w-full py-2.5 bg-slate-900 hover:bg-slate-800 text-white text-xs font-medium rounded-xl transition active:scale-95 disabled:opacity-50 mt-2"
 >
 ...
 <div>
 <div className="p-6">
 <h2 className="text-base font-medium text-slate-900">Your Referrals &amp; Payouts</h2>
 ...
 <div className="h-9 w-9 rounded-xl bg-slate-100 flex items-center justify-center font-medium text-slate-700 text-sm">
 {ref.referredUserName.charAt(0)}
 </div>
 <div>
 <div className="text-sm font-medium text-slate-900">{ref.referredUserName}</div>
 ...
 <span className="px-2.5 py-0.5 rounded-full bg-amber-100 text-amber-800 text-xs font-medium flex items-center space-x-1">
 <Clock className="h-3 w-3"/>
 <span>Pending</span>
 </span>
 <button
 onClick={() => onCompleteReferral(ref.id)}
 className="px-2.5 py-1 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-normal rounded-lg"
 >
 Simulate Join
 </button>
 </div>
