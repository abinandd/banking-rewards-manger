        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm flex items-center justify-between">
          <div>
            ...
            <div className="text-3xl font-black text-slate-900 mt-2">
              {wallet ? Number(wallet.pointsBalance).toLocaleString('en-IN') : '0'} <span className="text-lg font-semibold text-slate-400">PTS</span>
            </div>
              ...
              return (
                <div key={r.id} className="p-4 sm:p-5 flex items-center justify-between hover:bg-slate-50/50">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="flex items-center space-x-2">
                        <span className="font-bold text-slate-900 text-sm">{r.description}</span>
                        <span className={`text-[10px] uppercase tracking-wider px-2 py-0.5 rounded-md font-extrabold ${
                          r.status === 'CREDITED'
